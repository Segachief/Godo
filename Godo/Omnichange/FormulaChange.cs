...
namespace Godo.Omnichange
{
    ...
    {
        public static byte PickSpellDamageFormula(Random seed)
        {
            // List of valid damage formulae
            byte[] animSet = {  0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
                                0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
                                0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57,
                                0x70, 0x71, 0x76, 0x79, 0x7B};
        ...
        public static byte PickItemDamageFormula(Random seed)
        {
            // List of valid damage formulae
            byte[] animSet = {  0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37,
                                0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
                                0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57,
                                0x60, 0x61, 0x66, 0x69, 0x6B,
                                0x70, 0x71, 0x76, 0x79, 0x7B};
        ...
        public static byte PickEnemyDamageFormula(Random seed)
        {
            // List of valid damage formulae
            byte[] animSet = { 0x11, 0x12, 0x13, 0x17,
                                0x21, 0x22, 0x23, 0x27,
                                0x31, 0x32, 0x33, 0x37,
                                0x41, 0x42, 0x43, 0x47,
                                0x69, 0x6B, 0x6C,
